-- Read server\readme_tables.txt for comments and descriptions of these tables
-- and columns
-- InnoDB must be used because ECMNet needs a database engine that supports
-- transactions
-- latin1_bin is used because column values are case sensitive

drop table if exists PendingWork cascade;
drop table if exists UserStats cascade;
drop table if exists CompositeFactorEventDetail cascade;
drop table if exists CompositeFactorEvent cascade;
drop table if exists Composite cascade;
drop table if exists MasterCompositeSlaveSync cascade;
drop table if exists MasterCompositeWorkDone cascade;
drop table if exists MasterComposite cascade;
